...
export default function LandingPage() {
  ...
  return (
    <Layout>
      <nav className="fixed top-0 right-0 h-screen flex flex-col justify-center z-30 p-2 sm:p-4">
        {sections.map((section, index) => (
          <button
            key={section.id}
            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full my-1 sm:my-2 transition-all ${
